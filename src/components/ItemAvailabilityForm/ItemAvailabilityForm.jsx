...
function ItemAvailabilityForm({
	...
	return (
		<div className='avail'>
			...
			<label
				htmlFor='name'
				className='avail__label h3-labels'
			>
				Status
			</label>
			...
			{submit === true && quantityError === true && (
				<InventoryItemErrorState />
			)}
			...
			{submit === true && selectWarehouseError === true && (
				<InventoryItemErrorState />
			)}
		</div>
	);
