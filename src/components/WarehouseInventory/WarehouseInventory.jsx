		...
		<>
			<section className='warehouse'>
				<div className='warehouse__header'>
					<Link to='/'>
						<img
							className='warehouse__header-btn--back'
							src={backbtn}
							alt='back button'
						/>
					</Link>
					<h1 className='warehouse__header-title .h1-page-header'>
						{warehouse.warehouse_name}
					</h1>
					<div className='warehouse__header-btn--edit'>
						<Editbutton />
					</div>
				</div>
				<div className='warehouse__details'>
					<div className='warehouse__details-address'>
						<span className='h4-table-header '>
							WAREHOUSE ADDRESS:
						</span>
						<div className='warehouse__details-address-container'>
							<p className='p3-body-small'>
								{warehouse.address},
							</p>
							<p className='p3-body-small'>
