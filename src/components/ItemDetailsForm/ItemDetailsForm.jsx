...
function ItemDetailsForm({
	...
	return (
		<div className='details'>
			...
			<label
				htmlFor='name'
				className='details__label h3-labels'
			>
				Item Name
			</label>
			<input
			...
			/>
			{submit === true && itemNameError === true && (
				<InventoryItemErrorState />
			)}
			...
			<div className='details__select-wrap'>
				...
				>
					<option
						className='details__placeholder p2-body-medium'
						value=''
					>
						Please select
					</option>
			...
			{submit === true && categoryError === true && (
				<InventoryItemErrorState />
			)}
		</div>
	);
