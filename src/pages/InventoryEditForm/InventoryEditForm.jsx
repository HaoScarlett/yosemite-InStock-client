...
export default function InventoryEditForm() {
	...
	useEffect(() => {
		const loadItem = async () => {
			try {
				const [editItem, fetchedCategories, fetchedWarehouses] =
					await Promise.all([
				...
				setItem({
					...editItem.data[0],
					warehouse_id:
						editItem.data[0].warehouse_id ||
						editItem.data[0].warehouse,
				});
	...
	return (
		...
		>
			...
			<form
				...
				className='layout item-form__field'
			>
				<div className='item-form__wrapper'>
					<div className='item-form__details'>
						<h2 className='h2-subheader item-form__details-title'>
							Item Details
						</h2>
					...
					<div className='item-form__availability'>
						...
						<div className='item-form__status'>
							...
							<div className='item-form__status-wrapper'>
								<label
									htmlFor='status'
									className='item-form__radio-wrapper'
								>
									<input
										type='radio'
										name='status'
